...
import '../Footer/footer.css'; // Подключение стилей
...
import oneTree from '../../images/one-tree.png';
      ...
      <div className="container-footer">
        <div className="contatcs">
          ...
          <div className="raiting-company">
            ...
            <button className="button-newsletter" data-i18n="footer-newsletter-button">
